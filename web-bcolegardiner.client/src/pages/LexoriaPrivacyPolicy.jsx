...
export default function LexoriaPrivacyPolicy() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <section className="mx-auto max-w-4xl px-6 py-16">
        ...
        <h1 className="text-4xl font-black tracking-tight md:text-5xl">Lexoria Privacy Policy</h1>
        ...
        <div className="mt-10 space-y-8 rounded-3xl border border-white/10 bg-white/[0.04] p-6 leading-7 text-slate-200 shadow-2xl shadow-black/30 md:p-8">
          <section>
            ...
            <p className="mt-3">
              Lexoria is a mobile word roguelite game developed by Gardiner Interactive. This policy explains what
              information may be collected, used, or shared when you use Lexoria.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-white">Information Lexoria collects directly</h2>
            <p className="mt-3">
              Lexoria does not require an account, and we do not directly collect your name, email address, phone
          ...
          <section>
            ...
            <p className="mt-3">
              Lexoria may store gameplay progress, run state, settings, statistics, achievements, unlocks, and similar
          ...
          <section>
            ...
            <p className="mt-3">
              Lexoria uses Google AdMob to show ads, including rewarded ads and interstitial ads. Google AdMob may
          ...
          <section>
            ...
            <p className="mt-3">
              Lexoria is not directed to children under 13. We do not knowingly collect personal information from
          ...
          <section>
            ...
            <p className="mt-3">
              We may update this policy as Lexoria changes. The updated date at the top of this page will reflect the
              latest revision.
            </p>
          </section>
