...
export default function LexoriaDataSafety() {
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <section className="mx-auto max-w-4xl px-6 py-16">
        <p className="mb-3 text-sm font-semibold uppercase tracking-[0.3em] text-cyan-300">Gardiner Interactive</p>
        <h1 className="text-4xl font-black tracking-tight md:text-5xl">Lexoria Data Safety Summary</h1>
        <p className="mt-4 text-slate-300">
          This page summarizes Lexoria&apos;s expected Google Play data safety posture. The Play Console form should always
        ...
        <div className="mt-10 space-y-6 rounded-3xl border border-white/10 bg-white/[0.04] p-6 leading-7 text-slate-200 shadow-2xl shadow-black/30 md:p-8">
          <section>
            ...
            <p className="mt-3">Lexoria does not require users to create an account.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              Lexoria uses Google AdMob for advertising. The Google Mobile Ads SDK may process advertising identifiers,
          ...
          <section>
            ...
            <p className="mt-3">
              Lexoria does not directly collect precise location, contacts, photos, messages, health information,
